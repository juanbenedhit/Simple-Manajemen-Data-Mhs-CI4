...
<body class="text-gray-800 bg-gray-100">
    ...
    <div class="container max-w-3xl p-4 mx-auto sm:p-6 lg:p-8">
        ...
        <header class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-700 sm:text-3xl">Tambah Data Mahasiswa Baru</h1>
            <p class="mt-1 text-gray-500">Isi formulir di bawah ini untuk menambahkan data mahasiswa.</p>
        </header>
            ...
            <form action="/mahasiswa/store" method="POST">
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nim" id="nim" placeholder="Contoh: 20210001" class="block w-full px-3 py-2 mt-1 placeholder-gray-400 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>

                    <div>
                        <label for="nama" class="block text-sm font-medium text-gray-700">Nama Lengkap</label>
                        <input type="text" name="nama" id="nama" placeholder="Contoh: Budi Santoso" class="block w-full px-3 py-2 mt-1 placeholder-gray-400 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="angkatan" id="angkatan" placeholder="Contoh: 2021" class="block w-full px-3 py-2 mt-1 placeholder-gray-400 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                </div>
